...
var MainManager = function () {
        ...
        function i(a) {
            // (X = !X) ? ($("#bt_backtrack a").text("乐柔嘴巴: 开启"), aidn.util.setCookie("bt", "on", 2592e3)) : ($("#bt_backtrack a").text("乐柔嘴巴: 关闭"), aidn.util.setCookie("bt", "off", 2592e3)), a && a.preventDefault()
            
            (X = !X) ? ($("#bt_backtrack a").text("音量: 开启"), aidn.util.setCookie("bt", "on", 2592e3)) : ($("#bt_backtrack a").text("音量: 关闭"), aidn.util.setCookie("bt", "off", 2592e3)), a && a.preventDefault()
        }
        ...
        i(), aidn.util.webaudio ? ($("#ng").css("display", "none"), $(".ok").css("display", "block"), m && $("#scene_main .attention").html("轻触 &amp; 滑动!"), u || $("#scene_top .attention").text("* 把声音开大点，然后享受吧！")) : ($("#ng").css("display", "block"), $(".ok").css("display", "none"), u || $("#ng .atten").html("抱歉，</br>你的浏览器不支此页面")), PIXI.utils._saidHello = !0, aidn.window.resize(a)
    },
